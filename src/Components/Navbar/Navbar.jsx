    ...
    <>
      ...
      <div className="flex justify-around items-center">
        ...
        <div className="flex flex-row items-center">
          <Link path='/shop'className="font-inter text-base font-medium tracking-normal leading-none text-center mx-2">
            Shop
          </Link>
          <Link className="font-inter text-base font-medium tracking-normal leading-none text-center mx-2">
            Skills
          </Link>
          <Link className="font-inter text-base font-medium tracking-normal leading-none text-center mx-2">
            Stories
      ...
      <div className="text-center mt-4">
        <h1 className="text-2xl font-bold text-gray-800"><span color="blue">DISCOVER OUR PRODUCTS</span></h1>
        <p className="text-base text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sit amet consectetur nibh, vel mattis arcu. Sed vel vehicula purus, vel varius sapien. Donec tempus velit auctor orci consectetur bibendum. Etiam eu malesuada est. Sed commodo tempus auctor. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer congue rhoncus ligula id fermentum. Integer sit amet hendrerit libero, et dignissim lorem. Sed dictum ac arcu nec pretium. Aliquam tortor augue, posuere mollis volutpat rhoncus, ullamcorper sed mauris. Cras congue est nec efficitur placerat. Ut vitae nunc volutpat, iaculis dolor vitae, euismod dolor..</p>
      </div>
